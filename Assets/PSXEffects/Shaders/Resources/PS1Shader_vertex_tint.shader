Shader "PSXEffects/PS1Shader_vertex_tint"
{
	Properties
	{
		...
		SubShader
		{
			...
			Pass
			{
				...
				v2f vert(appdata v)
				{
				  ...
				  #if UNITY_COLORSPACE_GAMMA
					  specularIntensity.rgb = tex2D(_SpecularMap, adjUv) * _Specular * i.color.a;
				  #else
					  specularIntensity.rgb = LinearToGammaSpace(tex2D(_SpecularMap, adjUv)) * _Specular * i.color.a;
				  #endif
